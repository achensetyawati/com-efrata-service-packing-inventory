	...
	public class GarmentShippingInvoiceDataUtil : BaseDataUtil<GarmentShippingInvoiceRepository, GarmentShippingInvoiceModel>
	{
		...
		public   GarmentShippingInvoiceModel GetModels()
		{
			var items = new HashSet<GarmentShippingInvoiceItemModel> {
				new GarmentShippingInvoiceItemModel("ro", "scno", 1, "buyerbrandname", 1, 1, "comocode", "comoname", "comodesc","comodesc","comodesc","comodesc", 1, "pcs", 10, 10, 100, "usd", 1, "unitcode", 3, 1),new GarmentShippingInvoiceItemModel("ro", "scno", 1, "buyerbrandname", 1, 1, "comocode", "comoname", "comodesc","comodesc","comodesc","comodesc", 1, "pcs", 10, 10, 100, "usd", 1, "unitcode", 3, 2) };
        ...
        public GarmentShippingInvoiceModel CopyModel(GarmentShippingInvoiceModel om)
        {
            ...
            foreach (var i in om.Items)
            {
                ...
                items.Add(new GarmentShippingInvoiceItemModel(i.RONo, i.SCNo, i.BuyerBrandId, i.BuyerBrandName, i.Quantity, i.ComodityId, i.ComodityCode, i.ComodityName, i.ComodityDesc,i.Desc2,i.Desc3,i.Desc4, i.UomId, i.UomUnit, i.Price, i.PriceRO, i.Amount, i.CurrencyCode, i.UnitId, i.UnitCode, i.CMTPrice, i.PackingListItemId) { Id = i.Id });
            }
            ...
            var model = new GarmentShippingInvoiceModel(om.PackingListId, om.InvoiceNo,om.InvoiceDate,om.From,om.To,om.BuyerAgentId,om.BuyerAgentCode,om.BuyerAgentName,om.Consignee,
                ...
                om.CO,om.CODate,om.COTP,om.COTPDate,adjs, om.TotalAmount, om.ConsigneeAddress, om.DeliverTo, units, om.UserAuthorizedName, om.PackingListType) { Id = om.Id };
