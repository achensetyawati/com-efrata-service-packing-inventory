...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.Monitoring
{
    public class OmzetYearCountryServiceTest
    {
        ...
        public void GetReportData_Success()
        {
            ...
            var packinglistmodel = new GarmentPackingListModel("", "", "DL", 1, "", DateTimeOffset.Now, "", "", DateTimeOffset.Now, "", 1, "", "", "USA", "", "", DateTimeOffset.Now, DateTimeOffset.Now, DateTimeOffset.Now, true, true, "", "", "", null, 1, 1, 1, 1, null, "", "", "", "", "", "", "", true, true, 1, "", GarmentPackingListStatusEnum.CREATED, "", false, "", false, false, false, "", "", 1)
            {
                Id = 1
            };
            ...
            var invoiceItemModels = new HashSet<GarmentShippingInvoiceItemModel> {
                ...
                new GarmentShippingInvoiceItemModel("ro", "scno", 1, "buyerbrandname", 15, 1, "comocode", "comoname", "comodesc", "comodesc", "comodesc", "comodesc", 2, "SETS", 20, 20, 300, "usd", 1, "unitcode", 0, 2)
                {
                    Id = 1
                }
