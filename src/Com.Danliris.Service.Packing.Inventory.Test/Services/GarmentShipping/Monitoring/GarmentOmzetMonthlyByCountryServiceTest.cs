...
{
    public class GarmentOmetMonthlyByCountryServiceTest
    {
        ...
        protected GarmentOmzetMonthlyByCountryService GetService(IServiceProvider serviceProvider)
        {
            return new GarmentOmzetMonthlyByCountryService(serviceProvider);
        }
