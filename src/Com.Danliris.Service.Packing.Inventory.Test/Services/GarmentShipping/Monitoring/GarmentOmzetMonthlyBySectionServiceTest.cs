...
{
    public class GarmentOmetMonthlyBySectionServiceTest
    {
        ...
        protected GarmentOmzetMonthlyBySectionService GetService(IServiceProvider serviceProvider)
        {
            return new GarmentOmzetMonthlyBySectionService(serviceProvider);
        }
        ...
        public void GetReportData_Success()
        {
            ...
            var model2 = new GarmentPackingListModel("", "", "DL", 1, "A", DateTimeOffset.Now, "", "", DateTimeOffset.Now, "", 1, "", "", "", "", "", DateTimeOffset.Now, DateTimeOffset.Now, DateTimeOffset.Now, true, true, "", "", "", null, 1, 1, 1, 1, null, "", "", "", "", "", "", "", true, true, 1, "", GarmentPackingListStatusEnum.CREATED, "", true, "", true, true, true, "", "", 1)
            {
                Id = 1
            };
            ...
            var result = service.GetReportData(model2.SectionCode, DateTime.MinValue, DateTime.Now, 0);
