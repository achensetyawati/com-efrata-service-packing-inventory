...
{
    public class GarmentOmetMonthlyByBrandServiceTest
    {
        ...
        protected GarmentOmzetMonthlyByBrandService GetService(IServiceProvider serviceProvider)
        {
            return new GarmentOmzetMonthlyByBrandService(serviceProvider);
        }
        ...
        public void GetReportData_Success()
        {
            ...
            var model2 = new GarmentPackingListModel("", "", "DL", 1, "", DateTimeOffset.Now, "", "", DateTimeOffset.Now, "", 1, "B10", "", "", "", "", DateTimeOffset.Now, DateTimeOffset.Now, DateTimeOffset.Now, true, true, "", "", "", null, 1, 1, 1, 1, null, "", "", "", "", "", "", "", true, true, 1, "", GarmentPackingListStatusEnum.CREATED, "", false, "", false, false, false,"", "", 1)
            {
                Id = 1
            };
            ...
            var result = service.GetReportData(items.FirstOrDefault().BuyerBrandName, DateTime.MinValue, DateTime.Now, 0);
        ...
        public void GenerateExcel_Success()
        {
            ...
            var model2 = new GarmentPackingListModel("", "DL/219998", "DL", 1, "", DateTimeOffset.Now, "", "", DateTimeOffset.Now, "", 1, "B10", "", "", "", "", DateTimeOffset.Now, DateTimeOffset.Now, DateTimeOffset.Now, true, true, "", "", "", null, 1, 1, 1, 1, null, "", "", "", "", "", "", "", true, true, 1, "", GarmentPackingListStatusEnum.CREATED, "", false, "", false, false, false, "", "", 1)
            {
                Id = 1
            };
