    ...
    public class GarmentOmetMonthlyByComodityServiceTest
    {
        ...
        public void GetReportData_Success()
        {
            var items = new List<GarmentShippingInvoiceItemModel>
                {
                     new GarmentShippingInvoiceItemModel("", "", 1, "", 1, 1, "MS", "TES COMODITY 1", "", "comodesc", "comodesc", "comodesc", 1, "uom1", 1, 1, 1, "", 1, "C10", 1, 1)
                         {
                           GarmentShippingInvoiceId = 1
                         },
                     new GarmentShippingInvoiceItemModel("", "", 1, "", 1, 1, "LB", "TES COMODITY 2", "", "", "", "", 2, "Uom2", 1, 1, 1, "", 1, "C10", 1, 2)
                         {
                           GarmentShippingInvoiceId = 1
                         },
                     new GarmentShippingInvoiceItemModel("", "", 1, "", 1, 1, "GB", "TES COMODITY 3", "", "", "", "", 2, "Uom2", 1, 1, 1, "", 1, "B10", 0, 3)
                         {
                           GarmentShippingInvoiceId = 1
                         },
                };
            ...
            var model2 = new GarmentPackingListModel("", "", "DL", 1, "", DateTimeOffset.Now, "", "", DateTimeOffset.Now, "", 1, "", "", "", "Australia", "", DateTimeOffset.Now, DateTimeOffset.Now, DateTimeOffset.Now, true, true, "", "", "", null, 1, 1, 1, 1, null, "", "", "", "", "", "", "", true, true, 1, "", GarmentPackingListStatusEnum.CREATED, "", true, "", true, true, true, "", "", 1)
            {
                Id = 1
            };
