...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.GarmentShippingDebitNote
{
    public class GarmentShippingDebitNoteServiceTest
    {
        ...
        public async Task ReadPdfById_Success_USD()
        {
            ...
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.DN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 2, "BankName", "USD", 1, "", items);
        ...
        public async Task ReadPdfById_Success_USD1()
        {
            ...
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.DN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 2, "BankName", "USD", 1.50, "", items);
        ...
        public async Task ReadPdfById_Success_USD2()
        {
            ...
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.DN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 2, "BankName", "USD", 1.18, "", items);
        ...
        public async Task ReadPdfById_Success_USD3()
        {
            ...
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.DN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 2, "BankName", "USD", 1.74, "", items);
        ...
        public async Task ReadPdfById_Success_IDR()
        {
            ...
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.DN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 1, "", "IDR", 1, "", items);
