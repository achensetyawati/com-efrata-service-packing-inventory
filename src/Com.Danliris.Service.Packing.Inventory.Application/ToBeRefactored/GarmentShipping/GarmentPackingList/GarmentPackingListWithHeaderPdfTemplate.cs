...
{
    public class GarmentPackingListWithHeadePdfTemplate
    {
        private IIdentityProvider _identityProvider;

        public GarmentPackingListWithHeadePdfTemplate(IIdentityProvider identityProvider)
        {
        ...
        public MemoryStream GeneratePdfTemplate(GarmentPackingListViewModel viewModel, string fob, string cprice)
        {
            ...
            writer.PageEvent = new GarmentPackingListWithHeaderPDFTemplatePageEvent(_identityProvider, viewModel);
    ...
    class GarmentPackingListWithHeaderPDFTemplatePageEvent : PdfPageEventHelper
    {
        private IIdentityProvider identityProvider;
        private GarmentPackingListViewModel viewModel;

        public GarmentPackingListWithHeaderPDFTemplatePageEvent(IIdentityProvider identityProvider, GarmentPackingListViewModel viewModel)
        {
