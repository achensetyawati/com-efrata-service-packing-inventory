...
{
    public class GarmentShippingInvoiceWithHeaderPdfTemplate
    {
        public MemoryStream GeneratePdfTemplate(GarmentShippingInvoiceViewModel viewModel, Buyer buyer, BankAccount bank, GarmentPackingListViewModel pl, int timeoffset)
        {
            ...
            writer.PageEvent = new GarmentShippingInvoiceWithHeaderPdfTemplatePageEvent(viewModel, timeoffset);
            ...
            PdfPCell bodyTableHeader = new PdfPCell() { Border = Rectangle.BOTTOM_BORDER | Rectangle.RIGHT_BORDER | Rectangle.LEFT_BORDER, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
    ...
    class GarmentShippingInvoiceWithHeaderPdfTemplatePageEvent : iTextSharp.text.pdf.PdfPageEventHelper
    {
        private GarmentShippingInvoiceViewModel viewModel;
        private int timeoffset;

        public GarmentShippingInvoiceWithHeaderPdfTemplatePageEvent(GarmentShippingInvoiceViewModel viewModel, int timeoffset)
        {
