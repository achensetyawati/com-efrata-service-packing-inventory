...
{
    public class GarmentShippingLocalSalesDOPdfTemplate
    {
        public MemoryStream GeneratePdfTemplate(GarmentShippingLocalSalesDOViewModel viewModel, int timeoffset)
        {
            const int MARGIN = 20;
